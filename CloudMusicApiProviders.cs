...
namespace NeteaseCloudMusicApi {
	...
	{
		public static string AppVer = "3.1.25";
		/// <summary>
		/// 初始化昵称
		/// </summary>
		...
		}, BuildOptions("weapi", new Cookie[] { new Cookie("os", "pc"), new Cookie("appver", AppVer),  }, "pc"));
		...
		public static readonly CloudMusicApiProvider LoginQrCheck = new CloudMusicApiProvider("/login/qr/check", HttpMethod.Post, "https://music.163.com/weapi/login/qrcode/client/login", new ParameterInfo[] {
			new ParameterInfo("type", ParameterType.Constant, 1),
			new ParameterInfo("key", ParameterType.Required),
		}, BuildOptions("weapi", new Cookie[] { new Cookie("os", "pc"), new Cookie("appver", AppVer),  }, "pc"));
		...
		/// 云盘歌曲匹配
		/// </summary>
		public static readonly CloudMusicApiProvider UserCloudMatch = new CloudMusicApiProvider("/user/cloud/detail", HttpMethod.Post, "https://music.163.com/weapi/cloud/user/song/match", new ParameterInfo[] {
			new ParameterInfo("userId", ParameterType.Required),
			new ParameterInfo("songId", ParameterType.Required),
			new ParameterInfo("adjustSongId", ParameterType.Required),
		}, BuildOptions("weapi"));
